...
Route::get('/show_users',[UserController::class,'index'])->name('users.index')->middleware('SecureAdmin');
Route::delete('/delete_user/{id}',[UserController::class,'destroy'])->name('users.destroy')->middleware('SecureAdmin');
Route::get('/create_user',[UserController::class,'create'])->name('users.create')->middleware('SecureAdmin');
Route::post('/store_user',[UserController::class,'store'])->name('users.store')->middleware('SecureAdmin');
Route::get('/edit_user/{id}',[UserController::class,'edit'])->name('users.edit')->middleware('SecureAdmin');
Route::put('/update_user/{id}',[UserController::class,'update'])->name('users.update')->middleware('SecureAdmin');
